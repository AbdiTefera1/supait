      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href={`tel:${settings.contact_phone || '+251911234567'}`} className="flex items-center gap-2 text-sm text-gray-600 hover:text-red-700">
              <Phone size={15} /> {settings.contact_phone || '+251 911 234 567'}
            </a>
